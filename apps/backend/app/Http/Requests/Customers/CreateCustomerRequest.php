...
class CreateCustomerRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'customer_type_option_id' => ['nullable', 'uuid', Rule::exists('options', 'id')->where('group', Option::GROUP_CUSTOMER_TYPE)->whereNull('deleted_at')],
            'customerTypeOptionId' => ['nullable', 'uuid', Rule::exists('options', 'id')->where('group', Option::GROUP_CUSTOMER_TYPE)->whereNull('deleted_at')],
