...
class UpdateCustomerRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'lead_id' => ['sometimes', 'nullable', 'uuid', Rule::exists('leads', 'id')->whereNull('deleted_at')],
            'leadId' => ['sometimes', 'nullable', 'uuid', Rule::exists('leads', 'id')->whereNull('deleted_at')],
            ...
            'customer_type_option_id' => ['sometimes', 'nullable', 'uuid', Rule::exists('options', 'id')->where('group', Option::GROUP_CUSTOMER_TYPE)->whereNull('deleted_at')],
            'customerTypeOptionId' => ['sometimes', 'nullable', 'uuid', Rule::exists('options', 'id')->where('group', Option::GROUP_CUSTOMER_TYPE)->whereNull('deleted_at')],
