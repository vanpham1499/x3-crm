...
class ConvertLeadRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'project.service_id' => ['nullable', 'uuid', Rule::exists('services', 'id')->whereNull('deleted_at')],
            'project.serviceId' => ['nullable', 'uuid', Rule::exists('services', 'id')->whereNull('deleted_at')],
            'project.manager_user_id' => ['nullable', 'uuid', Rule::exists('users', 'id')->whereNull('deleted_at')],
            'project.managerUserId' => ['nullable', 'uuid', Rule::exists('users', 'id')->whereNull('deleted_at')],
            'project.sales_user_id' => ['nullable', 'uuid', Rule::exists('users', 'id')->whereNull('deleted_at')],
            'project.salesUserId' => ['nullable', 'uuid', Rule::exists('users', 'id')->whereNull('deleted_at')],
