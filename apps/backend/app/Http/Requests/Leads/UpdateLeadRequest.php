...
class UpdateLeadRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'status_option_id' => ['sometimes', 'nullable', 'integer', Rule::exists('options', 'id')->where('group', Option::GROUP_LEAD_STATUS)->whereNull('deleted_at')],
            'statusOptionId' => ['sometimes', 'nullable', 'integer', Rule::exists('options', 'id')->where('group', Option::GROUP_LEAD_STATUS)->whereNull('deleted_at')],
            'occurred_date' => ['sometimes', 'nullable', 'date'],
            'occurredDate' => ['sometimes', 'nullable', 'date'],
            'assigned_user_id' => ['sometimes', 'nullable', 'integer', Rule::exists('users', 'id')->whereNull('deleted_at')],
            'assignedUserId' => ['sometimes', 'nullable', 'integer', Rule::exists('users', 'id')->whereNull('deleted_at')],
            ...
            'interested_service_option_id' => ['sometimes', 'nullable', 'integer', Rule::exists('options', 'id')->where('group', Option::GROUP_LEAD_SERVICE)->whereNull('deleted_at')],
            ...
            'interestedServiceOptionId' => ['sometimes', 'nullable', 'integer', Rule::exists('options', 'id')->where('group', Option::GROUP_LEAD_SERVICE)->whereNull('deleted_at')],
            ...
            'interested_service_id' => ['sometimes', 'nullable', 'integer', Rule::exists('services', 'id')->whereNull('deleted_at')],
            'interestedServiceId' => ['sometimes', 'nullable', 'integer', Rule::exists('services', 'id')->whereNull('deleted_at')],
            ...
            'converted_customer_id' => ['sometimes', 'nullable', 'integer', Rule::exists('customers', 'id')->whereNull('deleted_at')],
            'convertedCustomerId' => ['sometimes', 'nullable', 'integer', Rule::exists('customers', 'id')->whereNull('deleted_at')],
        ];
    }
}
