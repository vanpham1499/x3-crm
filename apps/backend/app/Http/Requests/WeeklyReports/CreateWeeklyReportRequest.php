...
class CreateWeeklyReportRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'weekly_condition' => ['required_without:weeklyCondition', 'string', 'max:50'],
            'weeklyCondition' => ['required_without:weekly_condition', 'string', 'max:50'],
            'status' => ['nullable', 'string', 'max:50'],
            'weekly_spend_amount' => ['nullable', 'numeric', 'min:0'],
            'weeklySpendAmount' => ['nullable', 'numeric', 'min:0'],
            'average_weekly_budget' => ['nullable', 'numeric', 'min:0'],
            'averageWeeklyBudget' => ['nullable', 'numeric', 'min:0'],
            'remaining_account_budget' => ['nullable', 'numeric', 'min:0'],
            'remainingAccountBudget' => ['nullable', 'numeric', 'min:0'],
            'total_budget' => ['nullable', 'numeric', 'min:0'],
            'totalBudget' => ['nullable', 'numeric', 'min:0'],
