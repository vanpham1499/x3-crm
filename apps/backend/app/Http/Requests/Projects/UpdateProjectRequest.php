...
class UpdateProjectRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'project_type' => ['sometimes', Rule::in(['K', 'M', 'O', 'N'])],
            'projectType' => ['sometimes', Rule::in(['K', 'M', 'O', 'N'])],
            ...
            'report_weekday' => ['sometimes', 'nullable', 'integer', Rule::in([1, 2, 3, 4, 5])],
            'reportWeekday' => ['sometimes', 'nullable', 'integer', Rule::in([1, 2, 3, 4, 5])],
