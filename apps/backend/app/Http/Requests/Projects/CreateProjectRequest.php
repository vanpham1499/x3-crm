...
class CreateProjectRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'contract.contract_status_id' => ['nullable', 'integer', Rule::exists('statuses', 'id')->whereNull('deleted_at')],
            'contract.contractStatusId' => ['nullable', 'integer', Rule::exists('statuses', 'id')->whereNull('deleted_at')],
