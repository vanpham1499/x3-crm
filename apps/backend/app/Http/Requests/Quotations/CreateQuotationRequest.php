...
class CreateQuotationRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'lead_id' => ['required_without:leadId', 'uuid', Rule::exists('leads', 'id')->whereNull('deleted_at')],
            'leadId' => ['required_without:lead_id', 'uuid', Rule::exists('leads', 'id')->whereNull('deleted_at')],
            'service_id' => ['nullable', 'uuid', Rule::exists('services', 'id')->whereNull('deleted_at')],
            'serviceId' => ['nullable', 'uuid', Rule::exists('services', 'id')->whereNull('deleted_at')],
