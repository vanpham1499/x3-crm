...
class UpdateQuotationRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'topup_credit_enabled' => ['sometimes', 'boolean'],
            'topupCreditEnabled' => ['sometimes', 'boolean'],
            'topup_credit_limit' => ['sometimes', 'nullable', 'numeric', 'min:0'],
            'topupCreditLimit' => ['sometimes', 'nullable', 'numeric', 'min:0'],
            'topup_credit_note' => ['sometimes', 'nullable', 'string', 'max:2000'],
            'topupCreditNote' => ['sometimes', 'nullable', 'string', 'max:2000'],
            'account_reconciliation_image_urls' => ['sometimes', 'nullable', 'array', 'max:3'],
            'account_reconciliation_image_urls.*' => ['required', 'string', 'max:2048'],
            'accountReconciliationImageUrls' => ['sometimes', 'nullable', 'array', 'max:3'],
            'accountReconciliationImageUrls.*' => ['required', 'string', 'max:2048'],
