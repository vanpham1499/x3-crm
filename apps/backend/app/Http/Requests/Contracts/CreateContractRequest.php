...
class CreateContractRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'contract_status_id' => ['nullable', 'integer', Rule::exists('statuses', 'id')->whereNull('deleted_at')],
            'contractStatusId' => ['nullable', 'integer', Rule::exists('statuses', 'id')->whereNull('deleted_at')],
