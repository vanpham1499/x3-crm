...
return [
    ...
    'attributes' => [
        ...
        'planLink' => 'Link Driver khách hàng',
        ...
        'weeklySpendAmount' => 'chi phí tuần qua',
        'weekly_spend_amount' => 'chi phí tuần qua',
        'averageWeeklyBudget' => 'ngân sách trung bình/tuần',
        'average_weekly_budget' => 'ngân sách trung bình/tuần',
        'remainingAccountBudget' => 'ngân sách tài khoản còn lại',
        'remaining_account_budget' => 'ngân sách tài khoản còn lại',
        'totalBudget' => 'tổng ngân sách',
        'total_budget' => 'tổng ngân sách',
        'organizerUserId' => 'người phụ trách lịch hẹn',
        'subject' => 'tiêu đề lịch hẹn',
        'meetingType' => 'hình thức họp',
        'startsAt' => 'thời gian bắt đầu',
        'endsAt' => 'thời gian kết thúc',
        'meetingUrl' => 'đường dẫn họp',
        'participantUserIds' => 'người tham gia nội bộ',
        'guests' => 'người tham gia phía khách hàng',
        'allowConflict' => 'xác nhận lịch trùng',
        'result' => 'kết quả cuộc họp',
        'nextAction' => 'hành động tiếp theo',
        'nextActionDate' => 'ngày thực hiện tiếp theo',
        'reason' => 'lý do hủy',
