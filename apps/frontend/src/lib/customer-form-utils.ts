...
export function customerToFormValues(customer: Customer): CustomerFormValues {
  return {
    ...
    companyName: customer.companyName?.toLocaleUpperCase('vi-VN') || '',
    ...
    industry: customer.industryOption?.label || customer.industry || '',
    industryOptionId: idToString(customer.industryOptionId),
...
export function buildCustomerPayload(values: CustomerFormValues): CustomerPayload {
  ...
  return {
    ...
    companyName: emptyToNull(values.companyName)?.toLocaleUpperCase('vi-VN') ?? null,
    ...
    industryOptionId: emptyToNull(values.industryOptionId),
