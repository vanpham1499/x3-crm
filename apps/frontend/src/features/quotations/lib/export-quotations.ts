  ...
  downloadXlsxWorkbook(`Bao-phi_${exportedAt}.xlsx`, [
    {
      ...
      columns: [
        ...
        { header: 'Ngân sách đủ điều kiện nạp', width: 24 },
        { header: 'Hạn mức từ tiền đã thu', width: 24 },
        { header: 'Cho phép nợ', width: 16 },
        { header: 'Hạn mức nợ được duyệt', width: 24 },
        { header: 'Tổng được phép nạp', width: 22 },
        { header: 'Lý do cho phép nợ', width: 36 },
        { header: 'Người duyệt hạn mức nợ', width: 24 },
        { header: 'Ngày duyệt hạn mức nợ', width: 22 },
      ...
      rows: quotations.map((quotation) => [
        ...
        numberCell(quotation.topupEligibleAmount),
        numberCell(quotation.topupPaidBudget),
        quotation.topupCreditEnabled ? 'Có' : 'Không',
        numberCell(quotation.topupCreditBudget),
        numberCell(quotation.topupReleasedBudget),
        quotation.topupCreditNote || '',
        quotation.topupCreditApprovedBy?.name || '',
        dateTimeCell(quotation.topupCreditApprovedAt),
