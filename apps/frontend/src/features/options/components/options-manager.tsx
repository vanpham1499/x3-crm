    ...
    <div className="min-h-[calc(100vh-72px)] w-full bg-slate-50/60 p-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.16em] text-primary">Page list</p>
            <h2 className="mt-2 text-xl font-bold text-slate-950">Lead</h2>
            <p className="mt-1 text-sm text-slate-500">
              Quản lý các option dùng trong màn Lead: trạng thái, nguồn phát sinh và ngành nghề.
            </p>
          </div>
          {isFetching && <span className="text-sm font-semibold text-primary">Đang tải...</span>}
        </div>

        <div className="grid gap-5 xl:grid-cols-4">
          {LEAD_OPTION_GROUPS.map((group) => {
